...
contract LotteryMathTest is Test {
    ...
    function testCalculateJackpotReward(uint256 netProfit, uint256 fixedJackpotSize, uint256 ticketsSold) public {
        ...
        // assertGe(reward, fixedJackpotSize); //* @audit: OK
        assertEq(reward, fixedJackpotSize + excess / 2); //! @audit: There are some values that make this statement false. Not sure which ones but will reach out to the halmos team
    }
